...
class View:
    ...
    def load_interface(self):
        ...
        self.dd_prodotto_iniziale = ft.Dropdown(label="Prodotto Iniziale", width=350,
                                                on_change=self.controller.choice_prod_start)
        self.dd_prodotto_finale = ft.Dropdown(label="Prodotto Finale", width=350,
                                              on_change=self.controller.choice_prod_end)
